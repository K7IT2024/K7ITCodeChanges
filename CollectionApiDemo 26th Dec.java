...
public class CollectionApiDemo {
 ...
 System.out.println("is list1 having all elements of list2:"+list1.containsAll(list2));//true
	 	...
	 	6. by using iterator() :  iterator() method will give the return type is Iterator 
	 	 interface type its available under java.util package only. this interface having 2 
	        ...
	        -> in Iterator interface we have only 2 method 1. hasNext() 2.next()
	         ...
	         Note1: while iterating the list obj by using iterator interface we can't modify
		    ...
		    Iterator  it =  list1.iterator();
			while(it.hasNext()) {
				list1.add("new value");// here we are trying to add new element into 
										  list obj while iterating list
				System.out.println(it.next());
			}
			
	       output:
	           Exception in thread "main" java.util.ConcurrentModificationException
			Note2: if we want to add or remove the elements from list while 
				   iterating we should go for ListIterrator instead of simple iterator.
	...
	output:
		...
		Q)how to remove the element from list while iterator:
		--------------------------------------------------------
    ...
    Q)How to update the list value while iterator :
	--------------------------------------------------
	...
	output: 
		...
		Sort(); it will sort the elements in list be default ascending order.  
		 ...
		 example: 
		    ...
		    Collections.sort(list1); //  java.lang.ClassCastException: class why bez our list is 
			...
			output:
		     ...
		     Q)How to sort the elements in in the list in descending order :  
		   ...
		   Example:    
			...
			output:
             ...
             Q)How to add the derived objects into List:
             =============================================
             ArrayList list = new ArrayList();
			...
			Q)How to to sort the derived  elements in list:
			=================================================
            ...
            if we want avoid this class cast exception we should implements Comaprable 
            interface from our derived class i.e class and we should over ride 
            one inherited abstract method inside our person class i.e comapareTo(). this
		    ...
		    derived data type elements:
		      ...
		      2. in that corresponding derived element class we should override the 
		          equals and hashCode methods 
		      
		      3. that class should implements the Comparable interface and we should override
